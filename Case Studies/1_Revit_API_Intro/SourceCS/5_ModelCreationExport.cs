...
namespace IntroCs
{
    ...
    public class ModelCreationExport : IExternalCommand
    {
        ...
        public List<Wall> CreateWalls_v1()
        {
            ...
            if (level1 == null)
            {
                TaskDialog.Show("Create walls",
                  "Cannot find (Level 1). Maybe you use a different template? Try with DefaultImperial.rte.");
                return null;
            }
            ...
            {
                TaskDialog.Show("Create walls",
                  "Cannot find (Level 2). Maybe you use a different template? Try with DefaultImperial.rte.");
                return null;
            }
        ...
        public static List<Wall> CreateWalls(Document rvtDoc)
        {
            ...
            XYZ pt1 = new XYZ(16, 16, 0.0);
            XYZ pt2 = new XYZ(16, 16, 0.0);
        ...
        public static List<Wall> CreateWalls(Document rvtDoc, XYZ pt1, XYZ pt2)
        {
            ...
            {
                TaskDialog.Show(
                  "Create walls", "Cannot find (Level 1). Maybe you use a different template? Try with DefaultImperial.rte."
                );
                return null;
            }
            ...
            {
                TaskDialog.Show(
                  "Create walls", "Cannot find (Level 2). Maybe you use a different template? Try with DefaultImperial.rte."
                );
                return null;
            }
